    ...
    <div class="container">
        <div class="colonna-testo">
            <div class="about-section">
                <h2>Chi è Mirko</h2>
                <p>Mirko è una persona che durante le medie si è appassionata al mondo dell'informatica.</p>
                <p>Come qualsiasi fanciullo che si approccia a qualcosa per la prima volta, presi la decisione di imparare Visual Basic da autodidatta; nulla di male in questo, se non fosse per il fatto che per impararlo, scaricai un PDF da 800.</p>
                <p>Smisi di studiare qualche giorno dopo.</p>
                <p>Dopo diversi anni, nei quali studiai e mi appassionai alla filosofia, all'arte, al mondo videoludico e alla letteratura in generale, durante il mio primo lavoro come addetto in un grande supermercato, mi capitò tra le mani un corso gratuito su Java; mandai la domanda di applicazione e venni accettato.
                    Conclusi quel corso classificandomi primo tra tutti i corsisti e mi venne offerta una posizione nella stessa azienda.</p>
            ...
            <div class="experience-section">
                ...
                <p>Nel corso della mia carriera, ho avuto l'opportunità di lavorare su una vasta gamma di progetti, dalle applicazioni web complesse alle soluzioni software su misura per diverse industrie.</p>
            ...
            <div class="passion-section">
                <h2>Passioni</h2>
                <p>"Nell'ultimo periodo mi sono avvicinato al mondo dei content creator e sto ancora cercando di trovare la nicchia che fa al caso mio. Nel frattempo mi diletto nella creazione di video di gaming, ho una pagina TikTok e un canale Youtube dove carico spezzoni delle live che produco su Twitch.</p>
                <p>Le grafiche nei vari social sono tutte prodotte da me, l'editing dei video anche.</p>
                <p>Un'altra passione che per la quale sto cercando di crearmi il tempo necessario è il copywriting, sono convinto che sia una skill utile in ogni area della vita.</p>
